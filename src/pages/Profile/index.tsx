                ...
                <div className='profile-container'>
                    ...
                    <div className='profile-content'>
                        <div className='profile-box'>
                            <h1>Nome</h1>
                            <input required type="text" placeholder={data?.nome}  value={nome} onChange={e => setNome(e.target.value)}/>
                            {/* <p>{data?.nome}</p> */}
                        </div>
                        <div className='profile-box'>
                            <h1>Email</h1>
                            <input required type="text" placeholder={data?.email} value={email} onChange={e => setEmail(e.target.value)}/>
                            {/* <p>{data?.email}</p> */}
                        </div>
                    </div>
                    <div className='profile-content'>
